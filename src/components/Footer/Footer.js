    ...
    <footer>
      <Container>
          ...
          <Col xl={4}>
            <ul>
              <li>
                ...
                >
                  <AiOutlineFileDone /> Terms and Policies
                </NavLink>
              </li>
              <li>
                <NavLink
        ...
        <div className="text-center">
          <h5>
            A Courses website to help you understand the basic to advance level
            concepts.
          </h5>
        </div>
      </Container>
      <section className="copyright text-center">
        <h4>Copyright ChromaCourses {thisYear.getYear() + 1900}</h4>
      </section>
    </footer>
  );
};
